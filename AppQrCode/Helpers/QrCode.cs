...
namespace AppQrCode.Helpers
{
    public class QrEncoder
    {
        ...
        /// <returns>位图</returns>
        public static Bitmap Encode(string msg, int version, int pixel, string icon_path, int icon_size, int icon_border, bool white_edge)
        {
            ...
            Bitmap icon = icon_path == null ? null : new Bitmap(icon_path);
